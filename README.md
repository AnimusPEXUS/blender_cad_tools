...
1. Create construction premitives and rename them;
 ![img]( screenshots/Screenshot From 2026-09-25 15-07-29.png )
1. Use created premitives to model desired construction;
 ![img]( screenshots/Screenshot From 2026-09-25 15-08-33.png )
 ...
 * finally, perform calculation using corresponding button. as a result, new Text object created in blender and it's name written in field 'Result' - navigate to Blender's text editor and read result.
  ![img]( screenshots/Screenshot From 2026-09-25 15-09-06.png )
